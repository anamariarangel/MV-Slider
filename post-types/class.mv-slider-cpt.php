...
if( !class_exists( 'MV_Slider_Post_Type') ){
    class MV_Slider_Post_Type{
        function __construct(){
            ...
            add_action( 'save_post', array( $this, 'save_post' ), 10, 2 ); //salvar o post  - hook, callback, prioridade, nnúmero de parêmetros-
        ...
        public function create_post_type(){
            ...
            public function mv_slider_cpt_columns($columns){  //padrão columns -> $columns['id-da-coluna'] = 'Texto da Coluna';
                $columns['mv_slider_link_text'] = esc_html('Link Text', 'mv-slider');
                $columns['mv_slider_link_url'] = esc_html('Link URL', 'mv-slider');
                return $columns;
            }
