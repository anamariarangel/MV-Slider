...
if( ! class_exists( 'MV_Slider' ) ){
    class MV_Slider{
        ...
        public function register_scripts(){
            wp_register_script( 'mv-slider-main-jq', MV_SLIDER_URL . 'vendor/flexslider/jquery.flexslider-min.js', array( 'jquery' ),
             MV_SLIDER_VERSION, true );
             wp_register_script( 'mv-slider-mv-options-js', MV_SLIDER_URL . 'vendor/flexslider/flexslider.js', array( 'jquery' ),
             MV_SLIDER_VERSION, true );
             wp_register_style( 'mv-slider-main-.css', MV_SLIDER_URL . 'vendor/flexslider.css', array(), MV_SLIDER_VERSION, 'all');
